...
@Component({
  selector: 'app-create-email-template-document',
  templateUrl: './create-email-template-document.component.html',
  styleUrl: './create-email-template-document.component.css',
})
export class CreateEmailTemplateDocumentComponent {
